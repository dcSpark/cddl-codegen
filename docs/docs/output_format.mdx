...
fixed-value kind is covered — bool, null, undefined, uint, nint, text, and **float** (`? v: 2.5`): the float
...
occurrence, a non-final `*`, a rest tail inside a group-choice arm or inside a plain group's body,
