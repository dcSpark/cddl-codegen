...
export const REGISTRY: Gate[] = [
  ...
  { id: "lint_tracked_text", tier: "fast", kind: "cmd",
    cmd: ["bun", "run", "lint_tracked_text.ts"], cwd: MATRIX,
    script: "lint_tracked_text.ts", desc: "tracked authored-text UTF-8/control-byte + snapshot doubled-doc-marker lint" },
  ...
  { id: "generated_local_scope_wide_crates_compile", tier: "full", kind: "cmd", concurrent: MANUAL_HEAVY,
    cmd: ["cargo", "test", "--bin", "cddl-codegen", "generated_local_scope_wide_crates_compile", "--", "--ignored"],
    ignoredTest: "generated_local_scope_wide_crates_compile",
    desc: "generated-local scope-wide collision gate — registry-derived legal cells compile across native, JSON/WASM, and component faces (manual, #[ignore]d)" },
  { id: "recombination_crates_execute", tier: "full", kind: "cmd", concurrent: MANUAL_HEAVY,
    ...
    desc: "recombination fuzzer layer 2 (default profile): dual deterministic batch-plan --emit-tests execution of the ok compositions (manual, #[ignore]d)" },
  { id: "recombination_preserve_crates_execute", tier: "full", kind: "cmd", concurrent: MANUAL_HEAVY,
    ...
    desc: "recombination fuzzer layer 2 (preserve profile): dual deterministic batch-plan --preserve-encodings escalation of the ok compositions (manual, #[ignore]d)" },
  { id: "recombination_json_crates_execute", tier: "full", kind: "cmd", concurrent: MANUAL_HEAVY,
    ...
    desc: "recombination fuzzer layer 2 (json profile): dual deterministic batch-plan serde/schemars escalation of the ok compositions (manual, #[ignore]d)" },
  { id: "recombination_wasm_crates_check", tier: "full", kind: "cmd", concurrent: MANUAL_HEAVY,
    ...
    desc: "recombination fuzzer layer 2 (wasm profile): dual deterministic batch-plan --wasm=true cargo check of generated wasm crates (manual, #[ignore]d)" },
