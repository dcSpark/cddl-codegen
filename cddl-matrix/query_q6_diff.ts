...
const VENDOR_FEATURE_COUNT = 23; // the comment-DSL / sentinel surface — pinned (README.md § the model); 23 since the dsl.custom_encodings registration (a custom codec declares its own wire's encoding variables)
