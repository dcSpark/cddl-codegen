...
const VENDOR_FEATURE_COUNT = 20; // the comment-DSL / sentinel surface — pinned (README.md § the model); 20 since the dsl.ignore registration (open struct-map tolerate-and-drop rest-row flavor)
