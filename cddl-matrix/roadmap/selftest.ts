...
export const FROZEN_SELFTEST_SUBCASES: ReadonlyMap<string, readonly string[]> = new Map<string, readonly string[]>([
  ...
  ["against_all_wp4m_bootstrap_valid", ["valid_capability", "independent_issue", "no_capability", "structural_substitute", "undefined_substitute", "complete", "missing_base_debt", "missing_candidate_debt", "testing_authoritative", "owner_coordinate", "frozen_span_coordinate", "debt_coordinate"]],
