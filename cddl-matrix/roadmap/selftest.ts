...
export const FROZEN_NEGATIVE_SELFTEST_EXPECTATIONS: ReadonlyMap<string, ExpectedSelfTestIssue> =
  ...
  ["manifest_duplicate_record", { code: "E-MANIFEST-DUPLICATE", logical_path: "manifest[3]" }],
  ["manifest_missing_part", { code: "E-MANIFEST-MISSING", logical_path: "part[\"part\"]" }],
  ["manifest_orphan_record", { code: "E-MANIFEST-ORPHAN", logical_path: "record[\"matrix.fixture-work\"].projection_group" }],
  ["manifest_unknown_id", { code: "E-MANIFEST-UNKNOWN", logical_path: "manifest[1]" }],
  ["manifest_wrong_kind", { code: "E-MANIFEST-KIND", logical_path: "manifest[2]" }],
  ["manifest_duplicate_not_tiebroken", { code: "E-MANIFEST-DUPLICATE", logical_path: "manifest[3]" }],
  ...
  ["render_invalid_chunk_skips_projection_read", { code: "E-RENDER-AUTHORITY", logical_path: "span" }],
