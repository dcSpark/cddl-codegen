...
export function createProjectionWritePlan(request: ProjectionWriteRequest): ProjectionWritePlanResult {
  ...
  if (meta.schema_version !== 1 || meta.authority !== "authoritative") {
    issues.push(issue(request, "E-OUTPUT-AUTHORITY", "document.authority", "projection write requires authoritative roadmap v1"));
  }
