...
function caseFixtureRegistryNoOrphans(context: SelfTestContext): readonly string[] | undefined {
...
function caseFixtureRegistryMissingFile(context: SelfTestContext): readonly string[] | undefined {
  const inventory = context.ports.fixtures.enumerateFixtureFiles(FIXTURE_ROOT);
  const decoded = registry(context);
...
function caseFixtureRegistryUnlistedFile(context: SelfTestContext): readonly string[] | undefined {
...
function caseFixtureRegistryDuplicateId(context: SelfTestContext): readonly string[] | undefined {
  const inventory = context.ports.fixtures.enumerateFixtureFiles(FIXTURE_ROOT);
...
function caseFixtureFamilyFloors(context: SelfTestContext): readonly string[] | undefined {
...
function caseSlotResolverFourMatrixSlots(_context: SelfTestContext): readonly string[] | undefined {
...
function caseReferenceProviderMembersNonemptyOrDeclaredEmpty(context: SelfTestContext): readonly string[] | undefined {
...
function caseSelftestCaseIdsUnique(context: SelfTestContext): readonly string[] | undefined {
...
function caseSelftestCaseCountFloor(context: SelfTestContext): readonly string[] | undefined {
...
function caseSelftestEmptyCategoryMutation(context: SelfTestContext): readonly string[] | undefined {
...
function caseSelftestAllCategoriesReceipted(context: SelfTestContext): readonly string[] | undefined {
...
function caseIoEffectImportFunnel(context: SelfTestContext): readonly string[] | undefined {
...
function caseFixtureEnumerationRecursiveSorted(context: SelfTestContext): readonly string[] | undefined {
  const inventory = context.ports.fixtures.enumerateFixtureFiles(FIXTURE_ROOT);
...
function caseFixtureEnumerationRejectsEscape(context: SelfTestContext): readonly string[] | undefined {
...
function caseScratchGitArgvNoShell(context: SelfTestContext): readonly string[] | undefined {
...
function caseFixtureReadExactBytes(context: SelfTestContext): readonly string[] | undefined {
  const inventory = context.ports.fixtures.enumerateFixtureFiles(FIXTURE_ROOT);
...
function caseFixtureReadRejectsEscape(context: SelfTestContext): readonly string[] | undefined {
...
function caseFixtureReadMissingRejected(context: SelfTestContext): readonly string[] | undefined {
  expectIssue(
...
function caseFixtureReadPermissionExitTwo(_context: SelfTestContext): readonly string[] | undefined {
...
function caseFixtureReadOtherIoExitTwo(_context: SelfTestContext): readonly string[] | undefined {
  const failure = classifyRoadmapIoError(
...
function caseFixtureExpectedContentMismatch(context: SelfTestContext): readonly string[] | undefined {
  const inventory = context.ports.fixtures.enumerateFixtureFiles(FIXTURE_ROOT);
...
function caseFixtureStatusBundleNinePaths(context: SelfTestContext): readonly string[] | undefined {
...
function caseFixtureStatusBundleGoldenMapping(context: SelfTestContext): readonly string[] | undefined {
  const row = registry(context).rows.find((value) => value.kind === "status_compat_bundle");
  const expected = {
...
interface FixtureCaseSpec {
  ...
  readonly run: (context: SelfTestContext) => readonly string[] | undefined;
}

/**
 * One row per registered case: its category, its declared polarity, and the function that executes
 * it.  The mapped key type keeps the table total over the frozen ID inventory, so a renamed case
 * fails to typecheck rather than silently changing category through a name prefix.
 */
const FIXTURE_CASES: { readonly [K in RequiredFixtureSelfTestCaseId]: FixtureCaseSpec } = {
  fixture_registry_no_orphans: { category: "fixture-registry", polarity: "positive", run: caseFixtureRegistryNoOrphans },
  fixture_registry_missing_file: { category: "fixture-registry", polarity: "negative", run: caseFixtureRegistryMissingFile },
  fixture_registry_unlisted_file: { category: "fixture-registry", polarity: "negative", run: caseFixtureRegistryUnlistedFile },
  fixture_registry_duplicate_id: { category: "fixture-registry", polarity: "negative", run: caseFixtureRegistryDuplicateId },
  fixture_family_floors: { category: "fixture-registry", polarity: "positive", run: caseFixtureFamilyFloors },
  slot_resolver_four_matrix_slots: { category: "fixture-registry", polarity: "positive", run: caseSlotResolverFourMatrixSlots },
  reference_provider_members_nonempty_or_declared_empty: { category: "fixture-registry", polarity: "positive", run: caseReferenceProviderMembersNonemptyOrDeclaredEmpty },
  selftest_case_ids_unique: { category: "fixture-registry", polarity: "positive", run: caseSelftestCaseIdsUnique },
  selftest_case_count_floor: { category: "fixture-registry", polarity: "positive", run: caseSelftestCaseCountFloor },
  selftest_empty_category_mutation: { category: "fixture-registry", polarity: "negative", run: caseSelftestEmptyCategoryMutation },
  selftest_all_categories_receipted: { category: "fixture-registry", polarity: "positive", run: caseSelftestAllCategoriesReceipted },
  io_effect_import_funnel: { category: "io-harness", polarity: "positive", run: caseIoEffectImportFunnel },
  fixture_enumeration_recursive_sorted: { category: "io-harness", polarity: "positive", run: caseFixtureEnumerationRecursiveSorted },
  fixture_enumeration_rejects_escape: { category: "io-harness", polarity: "negative", run: caseFixtureEnumerationRejectsEscape },
  scratch_git_lifecycle: { category: "io-harness", polarity: "positive", run: caseScratchGitLifecycle },
  scratch_git_argv_no_shell: { category: "io-harness", polarity: "positive", run: caseScratchGitArgvNoShell },
  fixture_read_exact_bytes: { category: "io-harness", polarity: "positive", run: caseFixtureReadExactBytes },
  fixture_read_rejects_escape: { category: "io-harness", polarity: "negative", run: caseFixtureReadRejectsEscape },
  fixture_read_missing_rejected: { category: "io-harness", polarity: "negative", run: caseFixtureReadMissingRejected },
  fixture_read_permission_exit_two: { category: "io-harness", polarity: "negative", run: caseFixtureReadPermissionExitTwo },
  fixture_read_other_io_exit_two: { category: "io-harness", polarity: "negative", run: caseFixtureReadOtherIoExitTwo },
  fixture_expected_content_mismatch: { category: "fixture-registry", polarity: "negative", run: caseFixtureExpectedContentMismatch },
  fixture_status_bundle_nine_paths: { category: "status-compat", polarity: "positive", run: caseFixtureStatusBundleNinePaths },
  fixture_status_bundle_golden_mapping: { category: "status-compat", polarity: "positive", run: caseFixtureStatusBundleGoldenMapping },
};

export const FIXTURE_SELFTEST_CASES: readonly SelfTestCase[] = Object.freeze(
  REQUIRED_FIXTURE_SELFTEST_CASE_IDS.map((id) => {
    const spec = FIXTURE_CASES[id];
    return {
      id,
      category: spec.category,
      run(context: SelfTestContext): SelfTestResult {
        try { return { ok: true, polarity: spec.polarity, subcases: spec.run(context) }; }
        catch (error) { return fail(id, error, spec.polarity); }
      },
    };
  }),
);
