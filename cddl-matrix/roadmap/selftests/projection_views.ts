...
export const PROJECTION_VIEW_SELFTEST_CASES: readonly SelfTestCase[] = Object.freeze([
  {
    id: "projection_views_layout_and_provenance", category: "section-render", run(): SelfTestResult {
      ...
      assert(aliases.length === 22 && !aliases.includes("Next work 9") && !aliases.includes("Next work 18") && !aliases.includes("Next work 20") && !aliases.includes("Next work 25") && !aliases.includes("Next work 26") && aliases.includes("Next work 27"),
