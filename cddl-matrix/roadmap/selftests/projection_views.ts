...
export const PROJECTION_VIEW_SELFTEST_CASES: readonly SelfTestCase[] = Object.freeze([
  {
    id: "projection_views_layout_and_provenance", category: "section-render", run(): SelfTestResult {
      ...
      assert(aliases.length === 10 && !aliases.includes("Next work 3") && !aliases.includes("Next work 5") && !aliases.includes("Next work 9") && !aliases.includes("Next work 10") && !aliases.includes("Next work 12") && !aliases.includes("Next work 15") && !aliases.includes("Next work 16") && !aliases.includes("Next work 17") && !aliases.includes("Next work 18") && !aliases.includes("Next work 19") && !aliases.includes("Next work 20") && !aliases.includes("Next work 21") && !aliases.includes("Next work 22") && !aliases.includes("Next work 23") && !aliases.includes("Next work 24") && !aliases.includes("Next work 25") && !aliases.includes("Next work 26") && aliases.includes("Next work 27"),
