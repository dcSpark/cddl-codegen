...
(every default-supported row carries a `preserve`/`json` verdict; <!-- gen:sh:roadmap-emission -->3 divergences, 1 `json`-side, 2 `preserve`-side<!-- /gen:sh:roadmap-emission --> —
