...
**Status: gate-green.** <!-- status-header counts are generated — regenerate with: cd cddl-matrix && bun run project_status_headers.ts --write --><!-- gen:sh:roadmap-counts -->115 features (95 RFC8610 + 1 RFC9682 + 19 `CDDL_CODEGEN` vendor profile), 96 containment cells, and 245 cddl-codegen annotations<!-- /gen:sh:roadmap-counts -->, all axes reconciled/deterministic, with
...
(every default-supported row carries a `preserve`/`json` verdict; <!-- gen:sh:roadmap-emission -->7 divergences, 1 `json`-side, 6 `preserve`-side<!-- /gen:sh:roadmap-emission --> —
